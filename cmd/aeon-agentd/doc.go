...
//
// This repository has no flake.nix, so there is no packages.<system>.paimos-agentd
...
// paimos-agentd for darwin-arm64, darwin-amd64 and linux-amd64 and attaches
...
//
//	install -m 0755 paimos-agentd-darwin-arm64 "$HOME/.local/bin/paimos-agentd"
//
