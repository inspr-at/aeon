...
.remote{font-weight:650;color:var(--ink)}.people-wrap{position:relative}.people-toggle{display:flex;align-items:center;gap:5px}.avatar{display:inline-grid;place-items:center;flex:none;width:22px;height:22px;border-radius:50%;color:var(--surface);font-weight:700;font-size:11px}.people{position:absolute;right:0;top:100%;z-index:20;min-width:220px;padding:8px;margin:4px 0 0;list-style:none;border:1px solid var(--line-2);border-radius:10px;background:var(--surface-raised);box-shadow:var(--shadow-pop)}.people li{display:flex;align-items:center;gap:8px;padding:5px;white-space:nowrap}
