...
const props = defineProps<{ related: Related | null; customerId: string; admin: boolean; error?: string; canQuote?: boolean }>()
const emit = defineEmits<{ retry: []; changed: []; newQuote: [] }>()
