...
export const COPY: Record<DocLanguage, PublicCopy> = {
  de: {
    ...
    accepted: 'Dieses Angebot wurde angenommen.', acceptedOn: moment => ` Angenommen am ${moment}.`,
  ...
  en: {
    ...
    accepted: 'This quote has been accepted.', acceptedOn: moment => ` Accepted on ${moment}.`,
