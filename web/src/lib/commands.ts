...
export type Command = { name: 'new-ticket'; projectKey: string } | { name: 'new-knowledge'; projectKey: string } | { name: 'shortcuts' } | { name: 'releases' } | { name: 'palette' } | { name: 'new-quote' } | { name: 'log-time'; nodeId?: string }
