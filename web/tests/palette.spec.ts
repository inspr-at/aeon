...
test('an empty palette shows recents and actions for the project it opened in', async ({ page }) => {
  ...
  await expect(group(page, 'Actions')).toHaveText([/New ticket in PHAROS/, /Go to Outline/, /Go to Projects/, /Go to Agents/, /Switch to (dark|light) theme/, /Release history/, /Keyboard shortcuts/])
