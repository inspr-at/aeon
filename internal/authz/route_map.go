...
var RoutePermissions = map[string]string{
	...
	"DELETE /api/inbox/targets/{targetId}":                        "inbox.manage",
	"DELETE /api/kinds/{kindId}":                                  "kinds.manage",
	"DELETE /api/knowledge/{id}":                                  "knowledge.delete",
	"DELETE /api/me/avatar":                                       "profile.write",
	...
	"GET /api/crm/organisations/{organisationId}/note-ai":         "crm.read",
	...
	"GET /api/kinds":                                              "kinds.read",
	"GET /api/kinds/{kindId}":                                     "kinds.read",
	...
	"GET /api/me/greeting":                                        "profile.read",
	...
	"GET /api/projects/{projectId}/message-deliveries":                                "inbox.read",
	"GET /api/projects/{projectId}/message-targets":                                   "inbox.read",
	"GET /api/projects/{projectId}/messages":                                          "inbox.read",
	...
	"GET /api/quotes/{quoteId}/versions/{version}/public-link":                        "quotes.read",
	...
	"PATCH /api/me/profile":                                                           "profile.write",
	...
	"PATCH /api/tags/{tagId}":                                                         "tags.manage",
	...
	"POST /api/cost-units/{costUnitId}/rates":                                         "cost_units.write",
	...
	"POST /api/crm/organisations/{organisationId}/note-ai/generate":                   "crm.write",
	"POST /api/crm/organisations/{organisationId}/note-rewrite":                       "crm.write",
	"POST /api/crm/organisations/{organisationId}/note-rewrite/{draftId}/apply":       "crm.write",
	...
	"POST /api/inbox/targets":                                                         "inbox.manage",
	"POST /api/kinds":                                                                 "kinds.manage",
	"POST /api/knowledge":                                                             "knowledge.write",
	"POST /api/me/avatar":                                                             "profile.write",
	...
	"POST /api/projects/{projectId}/message-targets":                                            "inbox.send",
	...
	"POST /api/projects/{projectId}/messages/{messageId}/resolution":                            "inbox.send",
	...
	"POST /api/quotes/{quoteId}/versions/{version}/confirmation/retry": "quotes.write",
	"POST /api/quotes/{quoteId}/versions/{version}/issue":              "quotes.issue",
	"POST /api/quotes/{quoteId}/versions/{version}/public-link":        "quotes.write",
	"POST /api/quotes/{quoteId}/versions/{version}/public-link/revoke": "quotes.write",
